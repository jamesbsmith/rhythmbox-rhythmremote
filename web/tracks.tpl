...
<ul data-role="listview" data-inset="true" data-filter="true" data-autodividers="false">
	%for track in tracks:
	<li><a class="popup_select_link" data-rb-entry-id="{{track[0]}}" href="" data-transition="pop" data-rel="popup">{{track[1]}} {{track[2]}}</a></li>
	%end
</ul>
%for track in tracks:
<div data-role="popup" data-position-to="origin" id="popup_select_{{track[0]}}" data-theme="a">
	<ul data-role="listview" data-inset="true" style="min-width:210px;" data-theme="b">
		...
		<li><a class="track_link" data-rb-entry-id="{{track[0]}}" data-rb-entry-name="{{track[2]}}" href="#">Play</a></li>
		<li><a class="queue_link" data-rb-entry-id={{track[0]}} data-rb-entry-name="{{track[2]}}" href="#">Add to Queue</a></li>
